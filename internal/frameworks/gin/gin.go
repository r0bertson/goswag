...
func (r *ginRoute) QueryParamWithOptions(name, description, paramType string, required bool, opts *models.ParamOptions) models.Swagger {
...
func (r *ginRoute) HeaderParamWithOptions(name, description, paramType string, required bool, opts *models.ParamOptions) models.Swagger {
	param := generator.Param{
		Name:        name,
		Description: description,
		ParamType:   paramType,
...
func (r *ginRoute) PathParamWithOptions(name, description, paramType string, required bool, opts *models.ParamOptions) models.Swagger {
	param := generator.Param{
		Name:        name,
		Description: description,
		ParamType:   paramType,
...
func (r *ginRoute) FormDataParam(name, description, paramType string, required bool, opts *models.ParamOptions) models.Swagger {
	param := generator.Param{
		Name:        name,
		Description: description,
		ParamType:   paramType,
...
func (r *ginRoute) FileParam(name, description string, required bool) models.Swagger {
	param := generator.Param{
		Name:        name,
		Description: description,
		ParamType:   "file",
